...
NoteChordButton chords[36] = {
  { pcf[0].pin(0), {MIDI_Notes::Db(OCTAVE), CHORDS_CHANNEL}, Chords::Major },
  { pcf[0].pin(1), {MIDI_Notes::Ab(OCTAVE), CHORDS_CHANNEL}, Chords::Major },
  { pcf[0].pin(2), {MIDI_Notes::C(OCTAVE), CHORDS_CHANNEL}, Chords::Major },
  { pcf[0].pin(3), {MIDI_Notes::Eb(OCTAVE), CHORDS_CHANNEL}, Chords::Major },
  { pcf[0].pin(4), {MIDI_Notes::D(OCTAVE), CHORDS_CHANNEL}, Chords::Major },
  { pcf[0].pin(5), {MIDI_Notes::Gb(OCTAVE), CHORDS_CHANNEL}, Chords::Major },
  { pcf[0].pin(6), {MIDI_Notes::B(OCTAVE), CHORDS_CHANNEL}, Chords::Major },
  { pcf[0].pin(7), {MIDI_Notes::A(OCTAVE), CHORDS_CHANNEL}, Chords::Major },
  { pcf[1].pin(0), {MIDI_Notes::Db(OCTAVE), CHORDS_CHANNEL}, Chords::Major },
  { pcf[1].pin(1), {MIDI_Notes::Ab(OCTAVE), CHORDS_CHANNEL}, Chords::Major },
  { pcf[1].pin(2), {MIDI_Notes::C(OCTAVE), CHORDS_CHANNEL}, Chords::Major },
  { pcf[1].pin(3), {MIDI_Notes::Eb(OCTAVE), CHORDS_CHANNEL}, Chords::Major },
  { pcf[1].pin(4), {MIDI_Notes::D(OCTAVE), CHORDS_CHANNEL}, Chords::Major },
  { pcf[1].pin(5), {MIDI_Notes::Gb(OCTAVE), CHORDS_CHANNEL}, Chords::Major },
  { pcf[1].pin(6), {MIDI_Notes::B(OCTAVE), CHORDS_CHANNEL}, Chords::Major },
  { pcf[1].pin(7), {MIDI_Notes::A(OCTAVE), CHORDS_CHANNEL}, Chords::Major },
  { pcf[2].pin(0), {MIDI_Notes::Db(OCTAVE), CHORDS_CHANNEL}, Chords::Major },
  { pcf[2].pin(1), {MIDI_Notes::Ab(OCTAVE), CHORDS_CHANNEL}, Chords::Major },
  { pcf[2].pin(2), {MIDI_Notes::C(OCTAVE), CHORDS_CHANNEL}, Chords::Major },
  { pcf[2].pin(3), {MIDI_Notes::Eb(OCTAVE), CHORDS_CHANNEL}, Chords::Major },
  { pcf[3].pin(0), {MIDI_Notes::Db(OCTAVE), CHORDS_CHANNEL}, Chords::Major },
  { pcf[3].pin(1), {MIDI_Notes::Ab(OCTAVE), CHORDS_CHANNEL}, Chords::Major },
  { pcf[3].pin(2), {MIDI_Notes::C(OCTAVE), CHORDS_CHANNEL}, Chords::Major },
  { pcf[3].pin(3), {MIDI_Notes::Eb(OCTAVE), CHORDS_CHANNEL}, Chords::Major },
  { pcf[3].pin(4), {MIDI_Notes::D(OCTAVE), CHORDS_CHANNEL}, Chords::Major },
  { pcf[3].pin(5), {MIDI_Notes::Gb(OCTAVE), CHORDS_CHANNEL}, Chords::Major },
  { pcf[3].pin(6), {MIDI_Notes::B(OCTAVE), CHORDS_CHANNEL}, Chords::Major },
  { pcf[3].pin(7), {MIDI_Notes::A(OCTAVE), CHORDS_CHANNEL}, Chords::Major },
  { pcf[4].pin(0), {MIDI_Notes::Db(OCTAVE), CHORDS_CHANNEL}, Chords::Major },
  { pcf[4].pin(1), {MIDI_Notes::Ab(OCTAVE), CHORDS_CHANNEL}, Chords::Major },
  { pcf[4].pin(2), {MIDI_Notes::C(OCTAVE), CHORDS_CHANNEL}, Chords::Major },
  { pcf[4].pin(3), {MIDI_Notes::Eb(OCTAVE), CHORDS_CHANNEL}, Chords::Major },
  { pcf[4].pin(4), {MIDI_Notes::D(OCTAVE), CHORDS_CHANNEL}, Chords::Major },
  { pcf[4].pin(5), {MIDI_Notes::Gb(OCTAVE), CHORDS_CHANNEL}, Chords::Major },
  { pcf[4].pin(6), {MIDI_Notes::B(OCTAVE), CHORDS_CHANNEL}, Chords::Major },
  { pcf[4].pin(7), {MIDI_Notes::A(OCTAVE), CHORDS_CHANNEL}, Chords::Major },
};
